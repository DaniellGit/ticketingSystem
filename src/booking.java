	...
	public void actionPerformed(ActionEvent ev)
	{
		...
		if (ev.getSource() == submitbut)
		{
			...
			if (selectseat == 15)
				...
				if (selectedtime == "KUALA LUMPUR 22 OCTOBER 2022") //If they are trying to book a ticket a 1 o'clock
				{
				timechoice = 1;
				repaint();
				if (selectedblock == "Left Block") // If they are trying to book a seat in the left block
				{
					...
					else if (iftaken == 0)
					{
						...
						totalcost.setText("MYR"+ Integer.toString(totalprice)); //Updates and adds to the text box
			...
			if (selectedtime == "TOKYO 15 FEBRUARY 2023")
			{
				timechoice = 3;
				repaint();
				...
				if (selectedblock == "Left Block")
				{
					...
					else if (iftaken == 0)
					{
						...
						totalprice = totalprice + tempprice;
						totalcost.setText("MYR"+ Integer.toString(totalprice));
						totaltickets += 1;
						seat.setText("");
					}
				}
			...
			if (selectedtime == "REAL MADRID 10 MAY 2023")
			{
				timechoice = 5;
				repaint();
			...
			if (selectedtime == "MICHIGAN USA 17 JULY 2023")
			{
				timechoice = 7;
				repaint();
			...
			if (selectedtime == "JAKARTA INDONESIA 09 SEPTEMBER 2023")
			{
				timechoice = 9;
				repaint();
		...
		if (ev.getSource() == showbut)
		{
			...
			if (selectedtime == "KUALA LUMPUR 22 OCTOBER 2022")
			{
				timechoice = 1;
				repaint();
			}
...
class Ticket
{
	...
	public Ticket (String type, int seatnumber, String block, String time)
	{
		...
		if (blockticket == "Left Block")
		{
			...
			if (type == "Adult")
			{
				price = 228; //Setting adult price
			}
			if (type == "OAP")
			{
				price = 100; //Setting OAP price
			}
			if (type == "Child")
			{
				price = 170;  //Setting child price
			}
		}
