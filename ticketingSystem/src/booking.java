...
public class booking extends JFrame implements ActionListener
{
	...
	public booking()
	{
		...
		submitbut.setBounds(828, 7, 77, 31);
		submitbut.setBackground(Color.white);
		showbut = new JButton("Show");
		showbut.setBounds(731, 46, 77, 31);
